...
(() => {
  ...
  const faviconSvg = `data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 64 64'%3E%3Crect width='64' height='64' fill='${bg}'/%3E%3Ctext x='50%25' y='56%25' text-anchor='middle' dominant-baseline='middle' font-family='${encodeURIComponent(C.polices?.serif || 'Cormorant Garamond')},serif' font-style='italic' font-size='44' fill='${accent}'%3E${initiale}%3C/text%3E%3C/svg%3E`;
